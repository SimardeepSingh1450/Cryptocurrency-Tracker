...
const CryptoDetails = ({ setOpenModel }) => {
  ...
  return ReactDOM.createPortal(
    <div
      ...
      className="fixed top-0 w-full h-full bg-gray-700 bg-opacity-70 backdrop-blur-sm flex items-center justify-center"
    >
      <div
        onClick={(e) => e.stopPropagation()}
        className="w-[65%] h-[75%] bg-gray-700 bg-opacity-75 rounded-lg text-white relative overflow-y-auto"
      >
        {coinDataLoading ? (
          ...
          <div className="flex items-center justify-between h-full w-full p-4">
            <div className="flex flex-col w-[45%] h-full pr-2">
              <div className="flex w-full items-center">
                ...
                <span className="text-sm py-0.5 px-2.5 ml-2 bg-green-500 text-green-500 bg-opacity-25 rounded uppercase">
                  {coinData.symbol}
                </span>
              </div>
              ...
              <div className="flex w-full mt-6">
                <div className="flex flex-col w-full">
                  <div className="flex justify-between">
                    ...
                    <div
                      className={`py-0.5 text-sm px-1 ml-2 font-medium flex items-center rounded uppercase bg-opacity-25 ${
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col">
                  ...
                  <h2 className="text-base font-bold">
                    ...
                    }).format(coinData.market_data.market_cap[currentCurrency])}
                  </h2>
                </div>
                <div className="flex flex-col">
                  <span className="text-sm capitalize text-gray-100">
              ...
              <div className="flex flex-col w-full mt-4 justify-between">
                ...
                <h2 className="text-base font-bold">
                  {new Intl.NumberFormat("en-IN", {
                    ...
                    currency: currentCurrency,
                    minimumFractionDigits: 0,
                  }).format(coinData.market_data.total_volume[currentCurrency])}
                </h2>
              </div>
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col">
                  ...
                  <h2 className="text-base font-bold">
                    ...
                    }).format(coinData.market_data.low_24h[currentCurrency])}
                  </h2>
                </div>
                <div className="flex flex-col">
                  <span className="text-sm capitalize text-gray-100">
                  ...
                  <h2 className="text-base font-bold">
                    {new Intl.NumberFormat("en-IN", {
                      ...
                      currency: currentCurrency,
                      minimumFractionDigits: 5,
                    }).format(coinData.market_data.high_24h[currentCurrency])}
                  </h2>
                </div>
              </div>
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col">
                  <a
                    target={"blank"}
                    className="text-sm bg-gray-800 text-gray-100 px-1.5 py-1 my-1 rounded"
                ...
                <div className="flex flex-col content-start">
                  ...
                  <div className="flex justify-between">
                    <div
                      className={`py-0.5 text-sm px-1 ml-2 my-1 font-medium flex items-center rounded uppercase bg-opacity-25 bg-green-500 text-green-500`}
                    >
                      <span>
                  ...
                  <div className="flex justify-between">
                    <div
                      className={`py-0.5 text-sm px-1 my-1 ml-2 font-medium flex items-center rounded uppercase bg-opacity-25 bg-red-500 text-red-500`}
                    >
                      <span>
                        {Number(
            ...
            <div className="flex flex-col w-[55%] h-full pl-3">
              ...
              <div className="flex flex-col mt-4">
                <h3 className="text-white py-1">
                  <span className="font-bold text-gray-200 capitalize mr-1">
                    Market cap rank:{" "}
                  </span>
                  {coinData.market_cap_rank}
                </h3>
                <h3 className="text-white py-1 font-bold">
                  About {coinData.name} :
                </h3>
